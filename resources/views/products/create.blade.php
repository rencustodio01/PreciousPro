...
<div class="page-header">
    <div><h2>Add New Product</h2><small>Fill in jewelry product details below</small></div>
            ...
            <form method="POST" action="{{ route('products.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="base_price" step="0.01" min="0" class="form-control @error('base_price') is-invalid @enderror" value="{{ old('base_price') }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" maxlength="150">{{ old('description') }}</textarea>
                        @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-12 d-flex justify-content-end gap-2 pt-2">
                        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary">Cancel</a>
                        <button type="submit" class="btn btn-gold"><i class="bi bi-check-lg me-1"></i> Save Product</button>
                    </div>
                </div>
            </form>
        </div>
