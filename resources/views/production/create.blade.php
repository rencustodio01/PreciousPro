...
<div class="page-header">
    <div><h2>New Production Run</h2><small>Start a new manufacturing batch</small></div>
            ...
            <form method="POST" action="{{ route('production.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="production_date" class="form-control @error('production_date') is-invalid @enderror" value="{{ old('production_date', now()->format('Y-m-d')) }}" required max="{{ now()->format('Y-m-d') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="quantity_produced" class="form-control @error('quantity_produced') is-invalid @enderror" value="{{ old('quantity_produced') }}" required min="1">
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2 pt-2">
                        ...
                        <button type="submit" class="btn btn-gold"><i class="bi bi-check-lg me-1"></i> Save Production Run</button>
                    </div>
                </div>
            </form>
        </div>
